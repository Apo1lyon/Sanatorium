# Sanatorium
Эта программа позволяет регестрировать пациентов санатория и назначать им необходимые процедуры. 
База данных была построенна на основе SQL Server и управлялась с помощью СУБД MySql.
Основные таблицы, их создание и заполнение предоставленны в этом файле с помощью алгоритма.
