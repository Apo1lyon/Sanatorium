...
{
    /// <summary>
    /// Класс формы FormDoctorOffice
    /// </summary>
    public partial class FormDoctorOffice : TableForm
    {
        //Поля
        string tablePrimary = "DoctorOffice";

        /// <summary>
        /// Конструктор класса FormDoctorOffice
        /// </summary>
        ...
        private void btnAdd_Click(object sender, EventArgs e) => 
            AddValue($"insert into {tablePrimary} (DoctorOfficeID, NameDoctorOffice, Location) " +
