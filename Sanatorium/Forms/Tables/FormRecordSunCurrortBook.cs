...
{
    /// <summary>
    /// Класс формы FormRecordSunCurrortBook
    /// </summary>
    public partial class FormRecordSunCurrortBook : TableForm
    {
        //Поля
        ...
        /// <summary>
        /// Конструктор класса FormRecordSunCurrortBook
        /// </summary>
        ...
        AddValue($"insert into {tablePrimary} (SunCurrortBookID, DiagnosisID, AppointID, SpecialistID, Date) " +
            $"values ('{textBox1.Text}','{textBox2.Text}','{textBox3.Text}','{textBox4.Text}','{dateTimePicker1.Value}')");
        ...
        } //Получить данные за определённый промежуток
