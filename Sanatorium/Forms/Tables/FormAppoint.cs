...
namespace Sanatorium.Forms
{
    public partial class FormAppoint : TableForm
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e) => AddValue($"insert into {tablePrimary} (AppointID, MedicationID, ServicesID) values ('{textBox1.Text}','{textBox2.Text}','{textBox3.Text}')");
