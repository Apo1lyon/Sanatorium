...
{
    partial class ReportingPatient
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.patientTableAdapter = new Sanatorium.SanatoriumDataSetTableAdapters.PatientTableAdapter();
            ...
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Sanatorium.Forms.ReportingTables.Reporting.ReportPatient.rdlc";
            ...
            this.patientBindingSource.DataSource = this.sanatoriumDataSet;
            // 
            // patientTableAdapter
            // 
            ...
            this.Name = "ReportingPatient";
            this.Text = "Отчёт по пациентам";
            this.Load += new System.EventHandler(this.ReportingPatient_Load);
        ...
        private SanatoriumDataSetTableAdapters.PatientTableAdapter patientTableAdapter;
    }
}