...
{
    partial class ReportingAppoint
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.appointTableAdapter = new Sanatorium.SanatoriumDataSetTableAdapters.AppointTableAdapter();
            ...
            reportDataSource1.Name = "DataSetAppoint";
            reportDataSource1.Value = this.appointBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Sanatorium.Forms.ReportingTables.Reporting.ReportAppoint.rdlc";
            ...
            // 
            this.appointBindingSource.DataMember = "Appoint";
            this.appointBindingSource.DataSource = this.sanatoriumDataSet;
            // 
            // appointTableAdapter
            // 
            this.appointTableAdapter.ClearBeforeFill = true;
            // 
            // ReportingAppoint
            // 
            ...
            this.Name = "ReportingAppoint";
            this.Text = "Отчёт по назначениям";
            this.Load += new System.EventHandler(this.ReportingAppoint_Load);
        ...
        private SanatoriumDataSetTableAdapters.AppointTableAdapter appointTableAdapter;
    }
}