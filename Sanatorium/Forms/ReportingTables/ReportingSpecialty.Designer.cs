...
{
    partial class ReportingSpecialty
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.specialtyTableAdapter = new Sanatorium.SanatoriumDataSetTableAdapters.SpecialtyTableAdapter();
            ...
            reportDataSource1.Name = "DataSetSpecialty";
            reportDataSource1.Value = this.specialtyBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Sanatorium.Forms.ReportingTables.Reporting.ReportSpecialty.rdlc";
            ...
            this.specialtyBindingSource.DataSource = this.sanatoriumDataSet;
            // 
            ...
            this.Name = "ReportingSpecialty";
            this.Text = "Отчёт по специальностям";
            this.Load += new System.EventHandler(this.ReportingSpecialty_Load);
        ...
        private SanatoriumDataSetTableAdapters.SpecialtyTableAdapter specialtyTableAdapter;
    }
}