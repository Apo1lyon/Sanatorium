...
namespace Sanatorium.Forms
{
    partial class ReportingDiagnosis
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.diagnosisTableAdapter = new Sanatorium.SanatoriumDataSetTableAdapters.DiagnosisTableAdapter();
            ...
            reportDataSource1.Name = "DataSetDiagnosis";
            reportDataSource1.Value = this.diagnosisBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Sanatorium.Forms.ReportingTables.Reporting.ReportDiagnosis.rdlc";
            ...
            this.diagnosisBindingSource.DataSource = this.sanatoriumDataSet;
            // 
        ...
        private SanatoriumDataSetTableAdapters.DiagnosisTableAdapter diagnosisTableAdapter;
    }
}