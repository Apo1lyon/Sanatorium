...
{
    partial class ReportingMedication
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.medicationTableAdapter = new Sanatorium.SanatoriumDataSetTableAdapters.MedicationTableAdapter();
            ...
            reportDataSource1.Name = "DataSetMediacation";
            reportDataSource1.Value = this.medicationBindingSource;
            this.reportViewer1.LocalReport.DataSources.Add(reportDataSource1);
            this.reportViewer1.LocalReport.ReportEmbeddedResource = "Sanatorium.Forms.ReportingTables.Reporting.ReportMedication.rdlc";
            ...
            this.medicationBindingSource.DataSource = this.sanatoriumDataSet;
            // 
            ...
            this.Name = "ReportingMedication";
            this.Text = "Отчёт по препаратам";
            this.Load += new System.EventHandler(this.ReportingMedication_Load);
        ...
        private SanatoriumDataSetTableAdapters.MedicationTableAdapter medicationTableAdapter;
    }
}